...
public class Student {
    ...
    /**
     * SQL запити:
     * ALTER TABLE student_tracker.student AUTO_INCREMENT=3000 - починає відрахунок від 3000
     * TRUNCATE student_tracker.student - видаляє всі данні з бд а також відновля відрахунок від числа 1
    */
